...
public class AuthService {
    ...
    public User register(String fullName, String email, String rawPassword,
                         Role role, String nationalId) throws Exception {
